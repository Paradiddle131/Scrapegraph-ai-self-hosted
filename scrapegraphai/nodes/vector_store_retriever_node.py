...
class VectorStoreRetrieverNode(BaseNode):
    ...
    def execute(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.logger.info(f"Received query for retrieval: {retrieval_query_text[:100]}...")
        ...
        try:
            ...
            for hit in search_results:
                chunk_data = {
                    "text_content": hit.payload.get("text_chunk", ""),
        ...
        state[output_keys[0]] = retrieved_context_chunks
